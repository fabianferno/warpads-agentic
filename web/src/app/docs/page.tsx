            ...
            <div className="relative isolate min-h-[calc(100vh-4rem)] bg-slate-950 px-4 py-6 md:p-8">
                ...
                <div className="mx-auto max-w-4xl">
                    <div className="prose prose-invert max-w-none">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-6">Key Functionalities</h2>
                        ...
                        <div className="space-y-8">
                            <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800/50 ring-1 ring-white/10">
                                ...
                                <ol className="list-decimal list-inside space-y-2 text-slate-300">
                                    <li>Register as agent adspace on the protocol. This mints an ERC721 token for the agent. Copy the generated API key</li>
                                    <li>Install the WarpAds plugin and configure the `WARPAD_API_KEY` in the env</li>
                            ...
                            <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800/50 ring-1 ring-white/10">
                                ...
                                <ol className="list-decimal list-inside space-y-2 text-slate-300">
                                    <li>Create a new campaign: Each campaign is an ERC721 NFT which can be traded on any secondary marketplaces to utilize/update ad metadata. Ads are embedded and store on a vector store.</li>
                        ...
                        <div className="mt-12 space-y-8">
                            <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800/50 ring-1 ring-white/10">
                                <h3 className="text-xl font-semibold text-cyan-400 mb-4">Cookie DataSwarm API Integration</h3>
                                <p className="text-slate-300">
                            ...
                            <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800/50 ring-1 ring-white/10">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-lg font-semibold text-white mb-2">Sei Devnet</h4>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-white mb-2">Mode Testnet</h4>
                                        <div className="space-y-1 text-slate-300">
                                            <p><span className="text-cyan-400">warpTokenAddress:</span> 0x93316EbF65Bd209b3832a6d383d53905A97f9D90</p>
                                            <p><span className="text-cyan-400">adspaceAddress:</span> 0x57223AABb448F552Bd69cd48e4bCA980aDa9EAaB</p>
                                            <p><span className="text-cyan-400">adcampaignAddress:</span> 0x0DAbc440052ED94FfE69de2D704b1F151bF12c16</p>
