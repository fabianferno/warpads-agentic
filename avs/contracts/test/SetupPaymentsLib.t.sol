...
import "../script/utils/WarpAdsDeploymentLib.sol";
import "@eigenlayer/contracts/interfaces/IRewardsCoordinator.sol";
import "../src/IWarpAdsServiceManager.sol";
...
import "../script/WarpAdsDeployer.s.sol";
import {StrategyFactory} from "@eigenlayer/contracts/strategies/StrategyFactory.sol";
import {WarpAdsTaskManagerSetup} from "test/WarpAdsServiceManager.t.sol";
...
contract SetupPaymentsLibTest is Test, TestConstants, WarpAdsTaskManagerSetup {
    using SetupPaymentsLib for *;
    Vm cheats = Vm(VM_ADDRESS);

    IRewardsCoordinator public rewardsCoordinator;
    IWarpAdsServiceManager public warpAdsServiceManager;
    ...
    function setUp() public virtual override {
        ...
        ECDSAServiceManagerBase(warpAdsDeployment.warpAdsServiceManager)
    ...
    function testGenerateMerkleProof() public view {
        SetupPaymentsLib.PaymentLeaves memory paymentLeaves = SetupPaymentsLib
            .parseLeavesFromJson("test/mockData/scratch/payments_test.json");
